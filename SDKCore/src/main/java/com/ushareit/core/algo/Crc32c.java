...
public final class Crc32c implements Checksum {
    private final static String TAG = "Crc32c";
    ...
    public static String getCrc32String(SFile file) {
        try {
            Crc32c instance = new Crc32c();
            ...
            return Base64.encode(instance.getValueAsBytes());

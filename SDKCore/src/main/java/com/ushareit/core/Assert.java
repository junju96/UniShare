...
public final class Assert {
    ...
    public static void fail(String msg) {
        if (msg == null)
            msg = "invoke trace";
        Logger.f("ASSERTION-FAILED", msg, new Exception(msg));
    }
    ...
    public static void inRange(int value, int lowerBoundInclusive, int upperBoundExclusive) {
        ...
        fail(false, String.format(Locale.US, "value = %d, range = [%d, %d)", value, lowerBoundInclusive, upperBoundExclusive));
    }
    ...
    public static void equal(Object first, Object second) {
        equal(first, second, String.format(Locale.US, "first = %s, second = %s", first, second));
    }
    ...
    public static void equal(Object first, Object second, String msg) {
        ...
        if (first != null && second != null) {
            ...
            if (!first.equals(second))
                fail(msg);
        } else { // null don't equal to non-null
            fail(msg);
        }
    }
    ...
    public static void notEqual(Object first, Object second) {
        notEqual(first, second, String.format(Locale.US, "first = %s, second = %s", first, second));
    }
